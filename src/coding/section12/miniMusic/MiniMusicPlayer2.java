...
public class MiniMusicPlayer2 implements ControllerEventListener{
    ...
    private void go() {
        try {
            ...
            for(int i=5;i<80;i++){
                track.add(MiniMusicPlayer2.makeEvent(144,1,i,100,i));
                track.add(MiniMusicPlayer2.makeEvent(176,1,127,0,i));
                track.add(MiniMusicPlayer2.makeEvent(128,1,i,100,i+2));
            }
